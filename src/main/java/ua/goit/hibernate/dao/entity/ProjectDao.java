...
public class ProjectDao implements Comparable<ProjectDao> {
    ...
    @ManyToMany(fetch = FetchType.EAGER,
            targetEntity = ua.goit.hibernate.dao.entity.CompanyDao.class)
    ...
    @ManyToMany(fetch = FetchType.EAGER,
            targetEntity = ua.goit.hibernate.dao.entity.CustomerDao.class)
    ...
    public int compareTo(ProjectDao projectDao) {
        return Integer.compare(this.getId(), projectDao.getId());
    }
}
